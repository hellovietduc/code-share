  ...
  return (
    <section className="container px-5 py-24 mx-auto relative">
      {(() => {
        switch (codeString) {
          case undefined:
            return <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-center">Loading</p>;
          case null:
            return <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-center">Code Not Found</p>;
          default:
            return (
